...
<head>
    ...
    <link href="csss/main-page.css" rel="stylesheet">
    <title></title>
</head>
<body>
    ...
    <div class="main-container">
        <div style="overflow:hidden;position:relative;width:100%;">
            <div data-swipe-threshold="100" id="o1" class="gallery" style="width:3600px;position:relative;display:flex;">
    ...
    <div class="special-container">
        ...
        <div class="after product-grid">
            <div class="product-examples-purple">
                <div style="padding: 60px 0px 0px 4%; width: 50%; float: left;">
                    ...
                    <div style="padding-top: 6px;">
                        <a style="font-size: 14px;">0,5 Liter Flasche</a>
                ...
                <div class="product-examples-bottle">
                    <img style="width:auto;height:auto;" src="images/Laori-Juniper-Gin-Höhle-der-Löwen.png">
                </div>
            </div>
            <div class="product-examples-green">
                ...
                <div class="product-examples-bottle">
                    <img style="width:auto;height:auto;" src="images/jägermeister-bockbier_hertl.png">
                </div>
            </div>
        </div>
        <div style="margin: 19px 0px 45px 0px;">
            <div class="text-center font-36">DEIN TOR ZU VERBORGENEN GETRÄNKESCHÄTZEN</div>
            <div class="text-center font-18">Wir entdecken laufend neue Hidden Heroes für dich - Woche für Woche</div>
        </div>
        <div style="width:100%" class="after">
            <div class="mass-bottle">
                <div class="inlogo bottles-purple">
                    ...
                    <div class="card-price-font" style="text-align:center;">€ <span class="green-price">20,00</span></div>
    ...
    <div class="banner-purple">
        <div style="position: relative;" class="main-container">
            ...
            <div class="purple-text">
                <div style="margin: 0px 15px; padding-top:50px; width: 98%;">
                    ...
                    <div class="font-14">Abgerundet mit Muscovado-Zucker und Vanille aus Madagascar</div>
                    0,5l <span class="pl-25">für €</span> <span class="font-28">23,00</span>
                </div>
            </div>
        </div>
    </div>
    <div class="main-container">
        <div class="after exceptional">
            <div class="relative">
                <div class="absolute exceptional-text">
                    <div style="font-size: 22px;">SCHENK DIR WAS BESONDERES EIN!</div>
                    ...
                    <div>
                        <a style="color:#55a18c;font-size:14px;font-weight:600;border: 1px solid #55a18c;box-sizing: border-box;border-radius:3px;margin-top:30px;padding: 8px 20px;cursor:pointer;">LERN UNS NOCH BESSER KENNEN</a>
                    </div>
                </div>
                <div class="signature">
        ...
        <div class="after instagram">
            <div class="instagram-header">
                <p style="font-size:36px; margin:0;">Flüssig im Thema bleiben?</p>
                <p style="padding-top:10px; margin:0; line-height:18px;">Abonnier unseren Genussletter oder folge uns auf Instagram.</p>
            </div>
            <div style="width: 100%;">
                <div class="E-mail-field">
                    ...
                    <div class="E-mail-box">
                        <input style="margin-bottom:10px; padding: 7px 10px;" placeholder="E-Mail"> 
    ...
    <div class="special-container">
        <div class="after background-slash">
            <div class="left-box">
                ...
                <div style="color: #fff; width:80%">Wobei wir uns auch auf deinen Anruf freuen, wenn du einfach nur ein bisschen mit uns fachsimpeln magst.</div>
            </div>
            <div class="right-box">
                <a class="green-phone">030 99 00 47 41</a>
                <p style="color: #fff;">7 Tage die Woche von 10-22 Uhr</p>
            </div>
        </div>
    </div>
    <div class="main-container">
        <div style="padding-top:80px; padding-bottom: 80px;">
            <h2 style="margin-top:20px;margin-bottom:10px;text-align:center;letter-spacing:3px;font-size:34px;color:#10171f;">
